  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white font-sans selection:bg-[#41a100] selection:text-white">
      ...
      <header className="fixed top-0 left-0 w-full z-50 flex justify-center pt-4 px-4">
        <nav className="bg-[#18181b]/90 backdrop-blur-md border border-zinc-800/80 rounded-lg px-6 py-3 flex items-center justify-between w-full max-w-5xl shadow-2xl">
      ...
      <main className="max-w-5xl mx-auto px-6 pt-32 pb-16 min-h-[85vh] flex flex-col justify-center">
        <AnimatePresence mode="wait">
            ...
            >
              <div className="grid md:grid-cols-12 gap-8 items-center">
                <div className="md:col-span-7 space-y-6">
                  ...
                  <div className="pt-2 flex items-center space-x-4">
                    <button
                      ...
                      className="bg-[#41a100] hover:bg-[#4cc000] text-white font-mono text-sm px-6 py-3 rounded-md transition-all shadow-[0_0_20px_rgba(65,161,0,0.4)] flex items-center space-x-2"
                    >
                    ...
                    <button
                      ...
                      className="border border-zinc-800 bg-zinc-900/60 hover:bg-zinc-800 text-zinc-300 font-mono text-sm px-6 py-3 rounded-md transition-all"
                    >
                      Get in touch
                    </button>
                  </div>
                ...
                <div className="md:col-span-5 flex justify-center md:justify-end">
                  <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-2 border-zinc-800 shadow-2xl bg-zinc-900">
                    <Image
                      src="/profile1.jpg"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-zinc-800/80 pt-12">
            ...
            >
              <div>
                <h2 className="text-3xl font-bold tracking-tight mb-4 flex items-center gap-3">
                  <User className="text-[#41a100] w-7 h-7" /> About Me
                </h2>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-zinc-900/50 border border-zinc-800 p-5 rounded-lg space-y-2">
                  ...
                  <div className="bg-zinc-900/50 border border-zinc-800 p-5 rounded-lg space-y-2">
                    ...
                    <h4 className="font-medium text-white">CodeAlpha</h4>
                    <p className="text-xs text-zinc-400">
                  ...
                  <div className="bg-zinc-900/50 border border-zinc-800 p-5 rounded-lg space-y-2">
                    ...
                    <h4 className="font-medium text-white">Sci-Mi Mentorship</h4>
                    <p className="text-xs text-zinc-400">
              ...
              <div>
                ...
                <ul className="grid md:grid-cols-2 gap-3 text-sm text-zinc-300 font-mono">
                  <li className="flex items-start gap-2 bg-zinc-900/30 border border-zinc-800/60 p-3 rounded-md">
          ...
          {activeTab === "experience" && (
            ...
            >
              <h2 className="text-3xl font-bold tracking-tight mb-6 flex items-center gap-3">
                <Briefcase className="text-[#41a100] w-7 h-7" /> Experience & Leadership Journey
              </h2>

              <div className="space-y-8 border-l border-zinc-800 pl-6 ml-2">
                {/* Section 1 */}
                <div className="relative space-y-3">
                  <div className="absolute -left-[31px] top-1.5 w-3 h-3 rounded-full bg-[#41a100]" />
                  <span className="text-xs font-mono text-[#41a100]">Jan 2026 – Present</span>
                  <h3 className="text-xl font-semibold text-white">Startup Founder & Tech Innovator</h3>
                ...
                {/* Section 2 */}
                <div className="relative space-y-3">
                  <div className="absolute -left-[31px] top-1.5 w-3 h-3 rounded-full bg-zinc-700" />
                  <span className="text-xs font-mono text-[#41a100]">2023 – Present</span>
                  <h3 className="text-xl font-semibold text-white">Teaching, Volunteer Work & Community Impact</h3>
                  <div className="text-sm text-zinc-300 space-y-2">
                    <p>
                ...
                <div className="relative space-y-3">
                  ...
                  <h3 className="text-xl font-semibold text-white">Advocacy & Digital Literacy (ENG Ethiopia & Meta)</h3>
                  <div className="text-sm text-zinc-300 space-y-2">
                    <p>
                ...
                <div className="relative space-y-3">
                  ...
                  <h3 className="text-xl font-semibold text-white">Space Science & Astronomy (ESSS)</h3>
                  <div className="text-sm text-zinc-300 space-y-2">
                    <p>
                ...
                <div className="relative space-y-3">
                  ...
                  <h3 className="text-xl font-semibold text-white">Early Technology Roots</h3>
                  <div className="text-sm text-zinc-300 space-y-2">
                    <p>
          ...
          {activeTab === "projects" && (
            ...
            >
              <h2 className="text-3xl font-bold tracking-tight mb-2 flex items-center gap-3">
                <Code className="text-[#41a100] w-7 h-7" /> Featured Projects
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-zinc-900/60 border border-zinc-800 p-6 rounded-lg space-y-3 flex flex-col justify-between hover:border-zinc-700 transition-all">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-lg font-bold text-white">AXION Smart Wheelchair</h3>
                  ...
                  <div className="pt-3 flex flex-wrap gap-2 text-[10px] font-mono text-zinc-400">
                ...
                <div className="bg-zinc-900/60 border border-zinc-800 p-6 rounded-lg space-y-3 flex flex-col justify-between hover:border-zinc-700 transition-all">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-lg font-bold text-white">Focus2018 Exam Prep</h3>
                    <p className="text-xs text-zinc-300 leading-relaxed">
                ...
                <div className="bg-zinc-900/60 border border-zinc-800 p-6 rounded-lg space-y-3 flex flex-col justify-between hover:border-zinc-700 transition-all">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-lg font-bold text-white">PULSE Ethiopia</h3>
                    <p className="text-xs text-zinc-300 leading-relaxed">
                ...
                <div className="bg-zinc-900/60 border border-zinc-800 p-6 rounded-lg space-y-3 flex flex-col justify-between hover:border-zinc-700 transition-all">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-lg font-bold text-white">FAOSTAT CPI Data Analyzer</h3>
                    <p className="text-xs text-zinc-300 leading-relaxed">
                ...
                {/* Productivity App */}
                <div className="bg-zinc-900/60 border border-zinc-800 p-6 rounded-lg space-y-3 flex flex-col justify-between hover:border-zinc-700 transition-all md:col-span-2">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-mono text-[#41a100]">Mobile Development</span>
                      <ExternalLink className="w-4 h-4 text-[#41a100]" />
                    </div>
                    <h3 className="text-lg font-bold text-white">Productivity & Screen Time Control App</h3>
                    <p className="text-xs text-zinc-300 leading-relaxed">
          ...
          {activeTab === "contact" && (
            ...
            >
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-4 bg-zinc-900/40 p-6 rounded-lg border border-zinc-800">
                <div>
                  <label className="block text-xs font-mono text-zinc-400 mb-1">Your Name</label>
                  <input
                    type="text"
                    placeholder="Weldamlak Ayenew"
                    className="w-full bg-zinc-950 border border-zinc-800 rounded px-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#41a100] transition-colors"
                  />
                </div>
                <div>
